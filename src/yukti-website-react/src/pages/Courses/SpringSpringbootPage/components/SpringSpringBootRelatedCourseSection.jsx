...
const SpringSpringBootRelatedCourseSection = () => {
  return (
...
export default SpringSpringBootRelatedCourseSection;
const coursesData = [
  ...
  { slug: "mernsd", name: "SpringSpringBoot Stack Development", image: mernsdCoverPage },
