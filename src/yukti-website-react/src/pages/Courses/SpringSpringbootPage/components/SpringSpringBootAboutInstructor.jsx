...
const SpringSpringBootAboutInstructor = () => {
  return (
    <AboutInstructorSection
      ...
      theme={{
        ...
        textColor: "#6F7D66",
        titleColor: "#4E5D47",
        subtitleColor: "#4E5D47",
      }}
    />
  );
};

export default SpringSpringBootAboutInstructor;
const aboutInstructor = {
  ...
  points: [
    ...
    },
    {
      ...
      subtitle:
        "Guidance in modern stacks — SpringSpringBoot, DevOps, Cloud, DSA, system design & industry-standard tools.",
    },
    {
