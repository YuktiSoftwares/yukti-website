...
const CoreJavaToolsTechSection = () => {
  return (
...
export default CoreJavaToolsTechSection;
const toolsTech = {
  ...
  techList: [
    ...
    },
    {
      logo: reactLogo,
      name: "React",
      description: "CoreJava library for building fast and reusable user interfaces",
    },
    {
      logo: nextjslogo,
      name: "NextJS",
    ...
    },
    {
      logo: typescriptlogo,
      name: "TypeScript",
      description: "Typed superset of CoreJava that compiles to plain CoreJava",
    },
    {
      logo: angularjslogo,
      name: "Angular JS",
      description: "CoreJava framework for building dynamic single-page applications",
    },
    {
      logo: nodelogo,
      name: "Node JS",
      description: "CoreJava runtime for building scalable server-side applications",
    },
    {
      logo: expressLogo,
      name: "Express JS",
    ...
    },
    {
      logo: axiosLogo,
      name: "AXIOS",
      description: "Promise-based HTTP client for making API requests in CoreJava",
    },
    {
    ...
    },
    {
      ...
      name: "Babel",
      description:
        "CoreJava compiler that enables writing modern JS compatible with older browsers",
    },
    {
      logo: eclipselogo,
      name: "Eclipse",
