    ...
    <>
      ...
      <MKBox
        ...
        sx={{
          backgroundImage: ({ functions: { linearGradient, rgba }, palette: { gradients } }) =>
            ...
            )}, url(${constant.privacyPolicy.bgImage})`,
      ...
      >
        ...
        <ol>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Yukti Softwares, accessible from{" "}
              <a href="https://www.yuktisoftware.com/" target="_blank" rel="noreferrer">
                https://www.yuktisoftware.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ol>
          <li>
            <p>By email:&nbsp;contact@yuktisoftware.com</p>
          </li>
          <li>
            <p>
