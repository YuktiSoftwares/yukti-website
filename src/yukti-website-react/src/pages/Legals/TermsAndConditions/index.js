...
import termandcondition from "assets/images/modify_images/termandcondition.png";
function TermsAndConditions() {
  // const text = constant.privacyPolicy;
  return (
    <>
      <DefaultNavbar
        routes={routes}
      ...
      >
        ...
        <p>
          ...
          of our website, Yukti Softwares accessible at <span>this website</span>.
        </p>
        <p>
        ...
        <p>
          Other than the content you own, under these Terms, Yukti Softwares and/or its licensors
        ...
        <p>
          Certain areas of this Website are restricted from being access by you and Yukti Softwares
        ...
        <p>
          ...
          Content, you grant Yukti Softwares a non-exclusive, worldwide irrevocable, sub licensable
        ...
        <p>
          ...
          Yukti Softwares reserves the right to remove any of Your Content from this Website at any
          time without notice.
        </p>
        <h4>No warranties</h4>
        <p>
          This Website is provided “as is,” with all faults, and Yukti Softwares express no
        ...
        <p>
          In no event shall <span>Company Name</span>, nor any of its officers, directors and
          ...
          <span>Company Name</span>, including its officers, directors and employees shall not be
          held liable for any indirect, consequential or special liability arising out of or in any
          way related to your use of this Website.
        </p>
        <h4>Indemnification</h4>
        <p>
          You hereby indemnify to the fullest extent Yukti Softwares from and against any and/or all
        ...
        <p>
          Yukti Softwares is permitted to revise these Terms at any time as it sees fit, and by
          using this Website you are expected to review these Terms on a regular basis.
        </p>
        <h4>Assignment</h4>
        <p>
          The Yukti Softwares is allowed to assign, transfer, and subcontract its rights and/or
        ...
        <p>
          These Terms constitute the entire agreement between Yukti Softwares and you in relation to
        ...
        <p>
          ...
          of <span>Country</span>, and you submit to the non-exclusive jurisdiction of the state and
          federal courts located in <span>Country</span> for the resolution of any disputes.
        </p>
      </Card>
    </>
  );
